...
public class OritrqryOutputVO {
    ...
    public OritrqryOutputVO(Apr_dealtr_trn_tpcom_vs2001OutputVO apr) {
    ...
    public OritrqryOutputVO(Apr_dealtr_trn_tpcom_vs2003OutputVO apr) {
        mbrsh_pgm_id =              apr.getMbrsh_pgm_id();
        aprv_dy =                   apr.getAprv_dy();
        aprv_no =                   apr.getAprv_no();
        crd_no =                    apr.getCrd_no();
    ...
    public OritrqryOutputVO(Apr_dealtr_trn_tpcom_vs2004OutputVO apr) {
        mbrsh_pgm_id =              apr.getMbrsh_pgm_id();
        aprv_dy =                   apr.getAprv_dy();
        aprv_no =                   apr.getAprv_no();
        crd_no =                    apr.getCrd_no();
    ...
    public OritrqryOutputVO(Apr_dealtr_trn_tpcom_vs2035OutputVO apr) {
        mbrsh_pgm_id =              apr.getMbrsh_pgm_id();
        aprv_dy =                   apr.getAprv_dy();
        aprv_no =                   apr.getAprv_no();
        crd_no =                    apr.getCrd_no();
